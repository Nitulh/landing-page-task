...
const Empty = () => {
  ...
  useEffect(() => {
    const handleScroll = () => {
      ...
      const endRangePlan = 800;
      const startRangeVision = 800;
      const endRangeVision = 1000;
    ...
    <section id="about">
      <div className="container">
        ...
        <div className="row about-cols">
          <div
            className="col-md-4 about-col"
            style={{ opacity: scrollRanges.mission }}
          >
            <div className="img">
          ...
          <div
            className="col-md-4 about-col"
            style={{ opacity: scrollRanges.plan }}
          >
            <div className="img">
          ...
          <div
            className="col-md-4 about-col"
            style={{ opacity: scrollRanges.vision }}
          >
            <div className="img">
